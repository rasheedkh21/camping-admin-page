...
export default function Caravan() {
  ...
  const handleAddClick = async () => {
    try {
      const response = await fetch(`${BASEURL}tuning/addNewTuning`, {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      console.log("Error deleting tuning data", error);
    }
  };
  ...
  const handleUpdateClick = async (_id) => {
    try {
      const response = await fetch(`${BASEURL}tuning/${_id}`, {
        method: "PUT",
        headers: {
