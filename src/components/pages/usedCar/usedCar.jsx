...
export default function Caravan() {
  ...
  const handleAddClick = async () => {
    try {
      const response = await fetch(`${BASEURL}usedCar/addNewUsedCar`, {
        method: "POST",
        headers: {
      ...
      console.log("Add used car data is wrong:", error);
    }
  };
  ...
  const handleDelete = async (id) => {
    try {
      ...
      console.log("Error deleting used car data", error);
    }
  };
  ...
  const handleUpdateClick = async (_id) => {
    try {
      const response = await fetch(`${BASEURL}usedCar/${_id}`, {
        method: "PUT",
        headers: {
